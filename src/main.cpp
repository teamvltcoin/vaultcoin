...
uint256 hashGenesisBlock("0x000004625efac67e2b2daa58baff736e2c23c7535c2f9c68a191d33e7fd1ec37");
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
		...
		const char* pszTimestamp = "vault genesis";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1476373717;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1042227;
        ...
        assert(block.hashMerkleRoot == uint256("0xaee61ad7d48db4249f7e6d387f01f1fe46d469949b34a0c183fd54e530e699d5"));
...
unsigned char pchMessageStart[4] = { 0xfe, 0xc0, 0xb7, 0xbe }; // VaultCoin: increase each by adding 6 to bitcoin's value.
